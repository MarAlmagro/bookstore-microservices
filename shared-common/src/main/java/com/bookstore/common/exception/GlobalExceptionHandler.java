...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles validation errors from @Valid annotation - returns HTTP 400 Bad Request
     *
    ...
    /**
     * Handles all other uncaught exceptions - returns HTTP 500 Internal Server Error
     *
     * @param ex      the exception
     * @param request the web request
